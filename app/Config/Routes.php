...
$routes->group('admin', ['filter' => 'auth'], function($routes) {
	...
	// =====================================================================
	// Master Irban
	$routes->get('master/irban',                 'Admin\MasterIrbanController::index',                ['filter' => 'permission:master.view']);
	$routes->post('master/irban/data',           'Admin\MasterIrbanController::getData',              ['filter' => 'permission:master.view']);
	$routes->get('master/irban/create',          'Admin\MasterIrbanController::create',               ['filter' => 'permission:master.manage']);
	$routes->post('master/irban/store',          'Admin\MasterIrbanController::store',                ['filter' => 'permission:master.manage']);
	$routes->get('master/irban/edit/(:num)',     'Admin\MasterIrbanController::edit/$1',              ['filter' => 'permission:master.manage']);
	$routes->post('master/irban/update/(:num)', 'Admin\MasterIrbanController::update/$1',             ['filter' => 'permission:master.manage']);
	$routes->post('master/irban/delete/(:num)', 'Admin\MasterIrbanController::delete/$1',             ['filter' => 'permission:master.manage']);
	...
	$routes->post('master/entitas/store',       'Admin\MasterEntitasController::store',               ['filter' => 'permission:master.manage']);
	$routes->get('master/entitas/users',        'Admin\MasterEntitasController::getUsers',            ['filter' => 'permission:master.manage']);
	$routes->get('master/entitas/(:num)',       'Admin\MasterEntitasController::show/$1',             ['filter' => 'permission:master.view']);
	$routes->post('master/entitas/update/(:num)','Admin\MasterEntitasController::update/$1',          ['filter' => 'permission:master.manage']);
	$routes->post('master/entitas/delete/(:num)','Admin\MasterEntitasController::delete/$1',          ['filter' => 'permission:master.manage']);
	...
	$routes->post('master/sdm/store',           'Admin\MasterSdmController::store',                   ['filter' => 'permission:master.manage']);
	$routes->get('master/sdm/(:num)',           'Admin\MasterSdmController::show/$1',                 ['filter' => 'permission:master.view']);
	$routes->post('master/sdm/update/(:num)',   'Admin\MasterSdmController::update/$1',               ['filter' => 'permission:master.manage']);
	$routes->post('master/sdm/delete/(:num)',   'Admin\MasterSdmController::delete/$1',               ['filter' => 'permission:master.manage']);
	$routes->get('master/sdm/sisa-hp/(:num)',   'Admin\MasterSdmController::sisaHp/$1',               ['filter' => 'permission:master.view']);

	// =====================================================================
	// PKPT
	// =====================================================================
	// Header PKPT (dokumen SK per tahun)
	$routes->get('pkpt/setting',                  'Admin\PkptSettingController::index',                ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/setting/store',           'Admin\PkptSettingController::store',                ['filter' => 'permission:pkpt.manage']);
	$routes->post('pkpt/setting/approve/(:num)',  'Admin\PkptSettingController::approve/$1',           ['filter' => 'permission:pkpt.manage']);
	$routes->post('pkpt/setting/revok/(:num)',    'Admin\PkptSettingController::revok/$1',             ['filter' => 'permission:pkpt.manage']);
	$routes->post('pkpt/setting/delete/(:num)',   'Admin\PkptSettingController::delete/$1',            ['filter' => 'permission:pkpt.manage']);

	// Hari Libur
	$routes->get('pkpt/hari-libur',               'Admin\HariLiburController::index',                  ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/hari-libur/store',        'Admin\HariLiburController::store',                  ['filter' => 'permission:pkpt.manage']);
	$routes->post('pkpt/hari-libur/store-batch',  'Admin\HariLiburController::storeBatch',             ['filter' => 'permission:pkpt.manage']);
	$routes->post('pkpt/hari-libur/delete/(:num)','Admin\HariLiburController::delete/$1',              ['filter' => 'permission:pkpt.manage']);
	$routes->get('pkpt/hari-libur/hitung-hp',     'Admin\HariLiburController::hitungHp',               ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/hari-libur/data',         'Admin\HariLiburController::getData',                ['filter' => 'permission:pkpt.view']);

	$routes->get('pkpt',                            'Admin\PkptController::index',                      ['filter' => 'permission:pkpt.view']);
	$routes->get('pkpt/hp-monitor',                 'Admin\PkptController::hpMonitor',                  ['filter' => 'permission:pkpt.view']);
	$routes->get('pkpt/monitoring-sdm',             'Admin\PkptController::monitoringSdm',              ['filter' => 'permission:pkpt.view']);
	$routes->get('pkpt/monitoring-sdm/detail',      'Admin\PkptController::monitoringSdmDetail',        ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/data',                      'Admin\PkptController::getData',                    ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/buat',                      'Admin\PkptController::createOrGetPkpt',            ['filter' => 'permission:pkpt.input']);
	$routes->get('pkpt/(:num)',                     'Admin\PkptController::show/$1',                    ['filter' => 'permission:pkpt.view']);
	$routes->post('pkpt/(:num)/status',             'Admin\PkptController::updateStatus/$1',            ['filter' => 'permission:pkpt.manage']);
	$routes->get('pkpt/(:num)/kegiatan/create',    'Admin\PkptController::createKegiatan/$1',            ['filter' => 'permission:pkpt.input']);
	$routes->post('pkpt/(:num)/kegiatan/store',    'Admin\PkptController::storeKegiatan/$1',            ['filter' => 'permission:pkpt.input']);
	$routes->post('pkpt/(:num)/kegiatan/data',      'Admin\PkptController::getDataKegiatan/$1',          ['filter' => 'permission:pkpt.view']);
	$routes->get('pkpt/kegiatan/view/(:num)',       'Admin\PkptController::viewKegiatan/$1',             ['filter' => 'permission:pkpt.view']);
	$routes->get('pkpt/kegiatan/edit/(:num)',       'Admin\PkptController::editKegiatan/$1',             ['filter' => 'permission:pkpt.input']);
	$routes->post('pkpt/kegiatan/update/(:num)',    'Admin\PkptController::updateKegiatan/$1',           ['filter' => 'permission:pkpt.input']);
	$routes->post('pkpt/kegiatan/delete/(:num)',    'Admin\PkptController::deleteKegiatan/$1',           ['filter' => 'permission:pkpt.manage']);
	$routes->get('pkpt/sisa-hp',                    'Admin\PkptController::sisaHpSdm',                   ['filter' => 'permission:pkpt.view']);

	// =====================================================================
	// SPT
	// =====================================================================
	$routes->get('spt',                         'Admin\SptController::index',                         ['filter' => 'permission:spt.view']);
	$routes->post('spt/data',                   'Admin\SptController::getData',                       ['filter' => 'permission:spt.view']);
	$routes->get('spt/non-pkpt/create',         'Admin\SptController::createNonPkpt',                 ['filter' => 'permission:spt.create']);
	$routes->post('spt/non-pkpt/store',         'Admin\SptController::storeNonPkpt',                  ['filter' => 'permission:spt.create']);
	$routes->get('spt/create/(:num)',           'Admin\SptController::create/$1',                     ['filter' => 'permission:spt.create']);
	$routes->post('spt/store/(:num)',           'Admin\SptController::store/$1',                      ['filter' => 'permission:spt.create']);
	$routes->get('spt/(:num)',                  'Admin\SptController::show/$1',                       ['filter' => 'permission:spt.view']);
	$routes->get('spt/(:num)/edit',             'Admin\SptController::edit/$1',                       ['filter' => 'permission:spt.create']);
	$routes->post('spt/(:num)/update',          'Admin\SptController::update/$1',                     ['filter' => 'permission:spt.create']);
	$routes->post('spt/(:num)/ajukan',          'Admin\SptController::ajukan/$1',                     ['filter' => 'permission:spt.create']);
	$routes->post('spt/(:num)/approve',         'Admin\SptController::approve/$1',                    ['filter' => 'permission:spt.approve']);
	...
	// =====================================================================
	$routes->get('pka-template',                    'Admin\PkaTemplateController::index',                ['filter' => 'permission:master.view']);
	$routes->get('pka-template/create',             'Admin\PkaTemplateController::create',               ['filter' => 'permission:master.manage']);
	$routes->post('pka-template/store',             'Admin\PkaTemplateController::store',                ['filter' => 'permission:master.manage']);
	$routes->get('pka-template/(:num)/edit',        'Admin\PkaTemplateController::edit/$1',              ['filter' => 'permission:master.manage']);
	$routes->post('pka-template/(:num)/update',     'Admin\PkaTemplateController::update/$1',            ['filter' => 'permission:master.manage']);
	$routes->post('pka-template/(:num)/delete',     'Admin\PkaTemplateController::delete/$1',            ['filter' => 'permission:master.manage']);

	// =====================================================================
	// TEMUAN — per SPT
	// =====================================================================
	$routes->get('spt/(:num)/temuan',           'Admin\TemuanController::index/$1',                   ['filter' => 'permission:spt.view']);
	$routes->get('spt/(:num)/temuan/create',    'Admin\TemuanController::create/$1',                  ['filter' => 'permission:spt.create']);
	$routes->post('spt/(:num)/temuan/store',    'Admin\TemuanController::store/$1',                   ['filter' => 'permission:spt.create']);
	$routes->get('spt/temuan/(:num)',           'Admin\TemuanController::show/$1',                    ['filter' => 'permission:spt.view']);
	$routes->get('spt/temuan/(:num)/edit',      'Admin\TemuanController::edit/$1',                    ['filter' => 'permission:spt.create']);
	$routes->post('spt/temuan/(:num)/update',   'Admin\TemuanController::update/$1',                  ['filter' => 'permission:spt.create']);
	$routes->post('spt/temuan/(:num)/delete',   'Admin\TemuanController::delete/$1',                  ['filter' => 'permission:spt.create']);
	...
	// =====================================================================
	$routes->get('spt/(:num)/km',                         'Admin\KmController::index/$1',                          ['filter' => 'permission:spt.view']);
	...
	$routes->get('spt/(:num)/km/4',                       'Admin\KmController::km4/$1',                            ['filter' => 'permission:spt.view']);
	$routes->post('spt/(:num)/km/4/save',                 'Admin\KmController::saveKm4/$1',                        ['filter' => 'permission:spt.create']);
	// KM-5: Reviu PKA
	$routes->get('spt/(:num)/km/5',                       'Admin\KmController::km5/$1',                            ['filter' => 'permission:spt.view']);
	$routes->post('spt/(:num)/km/5/save',                 'Admin\KmController::saveKm5/$1',                        ['filter' => 'permission:spt.create']);
	// KM-5b: Entry Meeting
	...
	// Independensi
	$routes->get('spt/(:num)/km/independensi',            'Admin\KmController::independensi/$1',                   ['filter' => 'permission:spt.view']);
	$routes->post('spt/(:num)/km/independensi/save',      'Admin\KmController::saveIndepensi/$1',                  ['filter' => 'permission:spt.create']);
	// KM-10: Exit Meeting
	$routes->get('spt/(:num)/km/10',                      'Admin\KmController::km10/$1',                           ['filter' => 'permission:spt.view']);
	$routes->post('spt/(:num)/km/10/save',                'Admin\KmController::saveKm10/$1',                       ['filter' => 'permission:spt.create']);
	// KM-11: Reviu Laporan
	...
	$routes->get('spt/(:num)/kka',                        'Admin\KkaController::index/$1',                       ['filter' => 'permission:spt.view']);

	// KT Compiled View — rekapitulasi semua simpulan AT
	$routes->get('spt/(:num)/kka/compiled',               'Admin\KkaController::compiled/$1',                    ['filter' => 'permission:spt.view']);

	// Detail + isi KKA (show satu KKA per AT)
	$routes->get('kka/(:num)',                            'Admin\KkaController::show/$1',                        ['filter' => 'permission:spt.view']);

	// Ikhtisar
	$routes->post('kka/(:num)/ikhtisar/store',            'Admin\KkaController::storeIkhtisar/$1',               ['filter' => 'permission:spt.create']);
	$routes->post('kka/ikhtisar/(:num)/update',           'Admin\KkaController::updateIkhtisar/$1',              ['filter' => 'permission:spt.create']);
	$routes->post('kka/ikhtisar/(:num)/delete',           'Admin\KkaController::deleteIkhtisar/$1',              ['filter' => 'permission:spt.create']);
	$routes->post('kka/(:num)/ikhtisar/selesai',          'Admin\KkaController::selesaiIkhtisar/$1',             ['filter' => 'permission:spt.create']);

	// Simpulan
	$routes->post('kka/(:num)/simpulan/store',            'Admin\KkaController::storeSimpulan/$1',               ['filter' => 'permission:spt.create']);
	$routes->post('kka/simpulan/(:num)/update',           'Admin\KkaController::updateSimpulan/$1',              ['filter' => 'permission:spt.create']);
	$routes->post('kka/simpulan/(:num)/delete',           'Admin\KkaController::deleteSimpulan/$1',              ['filter' => 'permission:spt.create']);
	$routes->post('kka/(:num)/simpulan/selesai',          'Admin\KkaController::selesaiSimpulan/$1',             ['filter' => 'permission:spt.create']);

	// Rekomendasi
	$routes->post('kka/(:num)/rekomendasi/store',         'Admin\KkaController::storeRekomendasi/$1',            ['filter' => 'permission:spt.create']);
	$routes->post('kka/rekomendasi/(:num)/update',        'Admin\KkaController::updateRekomendasi/$1',           ['filter' => 'permission:spt.create']);
	$routes->post('kka/rekomendasi/(:num)/delete',        'Admin\KkaController::deleteRekomendasi/$1',           ['filter' => 'permission:spt.create']);
	$routes->post('kka/(:num)/rekomendasi/selesai',       'Admin\KkaController::selesaiRekomendasi/$1',          ['filter' => 'permission:spt.create']);

	// Unified save per prosedur (alur baru)
	$routes->post('kka/(:num)/prosedur/save',             'Admin\KkaController::saveProsedur/$1',                ['filter' => 'permission:spt.create']);
	...
	// =====================================================================
	$routes->get( 'spt/(:num)/nhp',                                  'Admin\NhpController::index/$1',                  ['filter' => 'permission:spt.view']);
	$routes->get( 'spt/(:num)/nhp/create',                           'Admin\NhpController::create/$1',                 ['filter' => 'permission:spt.create']);
	...
	$routes->post('tl/(:num)/verifikasi',                            'Admin\TlVerifikasiController::verifikasi/$1',    ['filter' => 'permission:spt.approve']);
	$routes->get( 'tl/dokumen/(:num)/download',                      'Admin\TlVerifikasiController::downloadDokumen/$1',['filter' => 'permission:spt.view']);
