...
class AppSettingSeeder extends Seeder
{
    public function run()
    {
        ...
        $defaults = [
            ...
            ['key' => 'org_name',    'value' => 'Nama Instansi',                       'type' => 'text',   'group' => 'general',    'label' => 'Nama Organisasi',        'description' => 'Nama lengkap instansi/perusahaan',         'sort_order' => 4],
            ['key' => 'org_short',   'value' => 'Instansi',                            'type' => 'text',   'group' => 'general',    'label' => 'Nama Singkat Organisasi','description' => 'Nama singkat untuk sidebar & header',      'sort_order' => 5],
            ['key' => 'org_website', 'value' => '#',                                   'type' => 'text',   'group' => 'general',    'label' => 'Website Organisasi',     'description' => 'URL website resmi organisasi',             'sort_order' => 6],
